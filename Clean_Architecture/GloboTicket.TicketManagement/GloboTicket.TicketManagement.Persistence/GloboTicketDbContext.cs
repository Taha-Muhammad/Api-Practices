    ...
    public class GloboTicketDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 65,
                Artist = "John Egbert",
                Date = new DateTime(2025,01,23).AddMonths(6),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Date = new DateTime(2025,01,23).AddMonths(9),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 85,
                Artist = "DJ 'The Mike'",
                Date = new DateTime(2025,01,23).AddMonths(4),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 400,
                Artist = "Many",
                Date = new DateTime(2025,01,23).AddMonths(10),
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Price = 135,
                Artist = "Nick Sailor",
                Date = new DateTime(2025,01,23).AddMonths(8),
            ...
            modelBuilder.Entity<Order>().HasData(new Order
            {
                ...
                OrderTotal = 400,
                OrderPaid = true,
                OrderPlaced = new DateTime(2025,01,23),
            ...
            foreach (var entry in ChangeTracker.Entries<AuditableEntity>())
            {
                switch (entry.State)
                {
                    case EntityState.Added:
                        entry.Entity.CreatedDate = new DateTime(2025,01,23);
                        break;
                    case EntityState.Modified:
                        entry.Entity.LastModifiedDate = new DateTime(2025,01,23);
                        break;
                }
            }
